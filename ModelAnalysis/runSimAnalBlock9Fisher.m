...
for intLoadSim=vecRunSims
	...
	strFigDir = ['C:\Data\Results\Block' strBlockNr '\'];
	strDataDir = ['C:\Data\Results\Data' strBlockNr '\'];
	...
	for intWithinArea=vecRunAreas
		...
		if ~boolAllZero
			...
			matFisher = doDimFisher(matX,vecTrialStimType,matCompareTypes,vecDoShuff,dblDiffTheta,intUseRepetitionMax);
