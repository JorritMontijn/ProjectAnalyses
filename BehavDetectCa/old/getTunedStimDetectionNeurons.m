function [indTuned,vecNeuronPrefStim,vecOSI,cellSes] = getTunedStimDetectionNeurons(cellSes,matRespMat)
	...
	if numel(cellSes) > 1
		...
		for intSes=1:intSessions
			for intNeuron=1:intNeurons
				...
				if ~strcmp(cellSes{intSes}.neuron(intNeuron).strRespType,'silent')
		...
		if nargin > 1 && ~isempty(matRespMat)
