...
for intPopIdx=1:intPops
	...
	indKeepTrialsTest = indKeepTrialsAud & vecTrialMisses;
...
if boolSavePlots
	strFigFile = ['DimCom4ST2_Misses_Window' sprintf('%.1f',dblBinSizeSecs) 'ProgressionNeuralDynamicsSummary' getDate];
