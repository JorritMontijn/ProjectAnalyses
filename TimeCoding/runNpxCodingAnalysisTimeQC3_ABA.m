...
for intRec=vecUseRec
	...
	for intArea=1:intAreas
		...
		%run predictions
		vecTrialGain_hat = doCrossValidatedDecodingRR(zscore(vecPupilSize(indUseTrials)),zscore(vecTrialGain(indUseTrials)),1,1);
		vecTrialMean_hat = doCrossValidatedDecodingRR(zscore(vecPupilSize(indUseTrials)),zscore(vecTrialMean(indUseTrials)),1,1);
