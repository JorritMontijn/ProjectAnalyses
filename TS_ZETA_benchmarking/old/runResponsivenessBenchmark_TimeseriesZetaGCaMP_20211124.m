...
intResampNum = 100;
boolSave = true;%true;
boolBuildPseudoTrace = true;
boolUseSuperResolution = true;
	...
	for intFile=1:numel(cellRunRecs)
		...
		for intNeuron=1:intNeurons%[1:intNeurons]%1:27, 2:69
			...
			if boolBuildPseudoTrace
				...
				[vecTraceT,vecTraceAct,vecEventStarts] = getPseudoTimeSeries(vecTimestamps,vecData,vecEventT,dblWindowDur);
		...
		if boolSave
			save([strDataTargetPath 'TraceZetaGCaMP_' strTitPD strTitSR strRunType 'Resamp' num2str(intResampNum) '.mat' ],...
