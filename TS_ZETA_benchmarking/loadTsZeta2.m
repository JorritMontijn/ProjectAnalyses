function [matMeanP,matZetaP,matAnovaP] = loadTsZeta2(strType)
	...
	sDirAll1=dir([strDataPath strType '*sesResamp*.mat']);
	sDirAll2=dir([strDataPath strType '*ses-RandResamp*.mat']);
