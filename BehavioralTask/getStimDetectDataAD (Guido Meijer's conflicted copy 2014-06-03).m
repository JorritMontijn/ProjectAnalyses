function [sContrast,sMetaData] = getStimDetectDataAD(ses,sStimAggregate)
	...
	for intContrastIndex=1:length(cellSelectC)
		...
		%add to output
		cellContrastPR{intContrastIndex} = vecPR;
		cellContrastNPR{intContrastIndex} = vecNPR;
		cellContrastPN{intContrastIndex} = vecPN;
		cellContrastNPN{intContrastIndex} = vecNPN;
		cellContrastPR_index{intContrastIndex} = vecPR_index;
		cellContrastNPR_index{intContrastIndex} = vecNPR_index;
		cellContrastPN_index{intContrastIndex} = vecPN_index;
		cellContrastNPN_index{intContrastIndex} = vecNPN_index;
	end
