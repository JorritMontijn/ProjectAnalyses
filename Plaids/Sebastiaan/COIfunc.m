function [CorrMatrixCOI] = COIfunc(dat, plaidsPVactall, plaidsact, plaidsactall, orientactall, orientpvactall, orientall, conditions, dataset)
...
ref_0_25 = plaidsact.vect(dataset).condition1;
ref_0_50 = plaidsact.vect(dataset).condition2;
ref_25_0 = plaidsact.vect(dataset).condition6;
ref_50_0 = plaidsact.vect(dataset).condition7;
...
COImatrix.m_0_25 = activity.single_0_25.matr;
COImatrix.m_25_0 = activity.single_25_0.matr;
COImatrix.m_0_50 = activity.single_0_50.matr;
COImatrix.m_50_0 = activity.single_50_0.matr;
COImatrix.m_0_100 = activity.single_0_100.matr;
COImatrix.m_100_0 = activity.single_100_0.matr;
...
for i = 1:length(orientall(dataset).significant)
    for j = 1:nRows
        [CorrMatrixCOI.vals.val_25_25(j,i), CorrMatrixCOI.vals.p_25_25(j,i)] = corr(PVactivity.all_25_25.matr(j,:)', COImatrix.m_25_25(i,:)');
        CorrMatrixCOI.final.COImean_25_25 = mean(mean(CorrMatrixCOI.vals.val_25_25));%calculating the mean correlation.
        CorrMatrixCOI.final.Pmean_50_50 = mean(mean(CorrMatrixCOI.vals.p_25_25));

        [CorrMatrixCOI.vals.val_25_50(j,i), CorrMatrixCOI.vals.p_25_50(j,i)] = corr(PVactivity.all_25_50.matr(j,:)', COImatrix.m_25_50(i,:)');
        CorrMatrixCOI.final.COImean_25_50 = mean(mean(CorrMatrixCOI.vals.val_25_50));
        CorrMatrixCOI.final.Pmean_25_50 = mean(mean(CorrMatrixCOI.vals.p_25_50));
        
        [CorrMatrixCOI.vals.val_50_25(j,i), CorrMatrixCOI.vals.p_50_25(j,i)] = corr(PVactivity.all_50_25.matr(j,:)', COImatrix.m_50_25(i,:)');
        CorrMatrixCOI.final.COImean_50_25 = mean(mean(CorrMatrixCOI.vals.val_50_25));
        CorrMatrixCOI.final.Pmean_50_25 = mean(mean(CorrMatrixCOI.vals.p_50_25));

        [CorrMatrixCOI.vals.val_50_50(j,i), CorrMatrixCOI.vals.p_50_50(j,i)] = corr(PVactivity.all_50_50.matr(j,:)', COImatrix.m_50_50(i,:)');
        CorrMatrixCOI.final.COImean_50_50 = mean(mean(CorrMatrixCOI.vals.val_50_50));
        CorrMatrixCOI.final.Pmean_50_50 = mean(mean(CorrMatrixCOI.vals.p_50_50));
        ...
        [CorrMatrixCOI.vals.val_0_50(j,i), CorrMatrixCOI.vals.p_0_50(j,i)] = corr(PVactivity.all_0_50.matr(j,:)', activity.single_0_50.matr(i,:)');
        CorrMatrixCOI.final.COImean_0_50 = mean(mean(CorrMatrixCOI.vals.val_0_50));%calculating the mean correlation.
        CorrMatrixCOI.final.Pmean_0_50 = mean(mean(CorrMatrixCOI.vals.p_0_50));

        [CorrMatrixCOI.vals.val_50_0(j,i), CorrMatrixCOI.vals.p_50_0(j,i)] = corr(PVactivity.all_50_0.matr(j,:)', COImatrix.m_50_0(i,:)');
        ...
        [CorrMatrixCOI.vals.val_0_100(j,i), CorrMatrixCOI.vals.p_0_100(j,i)] = corr(PVactivity.all_0_100.matr(j,:)', activity.single_0_100.matr(i,:)');
        ...
        [CorrMatrixCOI.vals.val_100_0(j,i), CorrMatrixCOI.vals.p_100_0(j,i)] = corr(PVactivity.all_100_0.matr(j,:)', COImatrix.m_100_0(i,:)');
