...
intSubSampleN = 101;%round(mean(vecNeuronN)); %mean N=101
intSubSampleT = 802;%round(mean(vecTrialT)); %mean T=802
...
if intType == 1
	vecRunSims = [-3 -4 -5 -8 -9 -10];%[-27:-21 -14 -13 -12 -10 -7:-1];
end
if intType == 2
	vecRunSims = [-8 -9 -10];%[21 11 22 23];
end
if intType == 3
	vecRunSims = 1;%[20 21 22 23];%[21 11 22 23];
end
if intType == 4
	vecRunSims = [100:2:110 150];%200:2:220;
end
