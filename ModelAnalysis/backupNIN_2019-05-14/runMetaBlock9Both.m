...
strDataDir2 = 'D:\Data\Results\Data9Merge\';
...
for intFileIdx=1:numel(sFiles)
	...
	%get relative information for raw and shuffled data
	matRawFisher = sLoadMerge.matRawFisher';
	matShuffFisher = sLoadMerge.matShuffFisher';
	if size(matRawFisher,1) == size(matShuffFisher,1)
		%normalize to shuffled
		matPhiMerge = (matRawFisher - matShuffFisher);% ./ (1 - matRelShuff + 1/1000);
