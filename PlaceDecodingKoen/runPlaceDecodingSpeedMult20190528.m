...
for intNeuron = 1:intNeurons
	...
	if intFoldK < 2
		...
		%% cv
		cellCoeffs0 = {0,0,0,[0,0,1],0,0};
		[vecPredY_CV,cellMeanCoeffs,matOutX,cellFunctions,cellFoldCoeffs,cellFoldTestObs] = gnmkfold(intFoldK,vecTrialRepetition,matX,vecY,cellCoeffs0,'gnmgauss',4,'times_mult',6);
		cellCoefficients(intNeuron,:) = cellMeanCoeffs;
