...
clear all
%% parameters
strFigDir = 'D:\Data\Results\stimdetection\metaNS_400msPostStim';
...
% 		intCounterF1 = intCounterF1 + 1;
	...
	strFile = sDir(intFile).name;
	strRec = getFlankedBy(strFile,'data_aggregateNS_PostStim','_');
	intRec = find(strcmp(strRec,cellInclude),1);
	if ~isempty(intRec)
		%load file
		load(strFile);
...
if ~(intCounterF1 == intCounterF2)
	warning([mfilename ':InconsistentFileNumbers'],'File counters inconsistent; F1=%d; F2=%d',intCounterF1,intCounterF2)
end
