		...
		for intRandType=vecRandTypes
			...
			for intResampleIdx = 1:numel(vecResamples)
				...
				for intNeuron=[1:intNeurons]%31
					...
					hTicM = tic;
					boolUseGumbel = true;
					dblISIP = getISItest(vecSpikeTimes,matEventTimes,dblUseMaxDur,intResampleNum,boolUseGumbel);
				...
				%save
				if boolSave
					save([strDataTargetPath 'ZetaGISI' strRunType strRunStim 'Resamp' num2str(intResampleNum) '.mat' ],...
