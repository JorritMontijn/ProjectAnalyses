...
for intRunType=vecRunTypes
	...
	for intFile=1:numel(cellRunRecs)
		...
		for intNeuron=1:intNeurons%[1:intNeurons]%1:27, 2:69
			...
			%stitch trials
			[vecAlignedT,matTracePerTrial,vecAdjustedEventT] = getTimeSeriesInTrial(vecTimestamps,vecData,vecEventStarts,dblSamplingInterval,dblUseMaxDur)
			...
			[vecPseudoTime,vecPseudoData,vecPseudoStarts] = getPseudoTimeSeries(vecTimestamps,vecData,vecEventT,dblWindowDur);
