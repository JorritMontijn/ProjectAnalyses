...
for intRec=1:numel(sAggStim) %19 || weird: 11
	...
	for intArea=1:intAreas
		...
		%get predictability
		[dblR2_G,dblSS_tot_G,dblSS_res_G,dblT_G,dblP_G,dblR2_adjusted_G,dblR2_SE_G] = getR2(matBinnedRate-matBinnedStim,matPredGainCV-matBinnedStim,intK_M);
		[dblR2_M,dblSS_tot_M,dblSS_res_M,dblT_M,dblP_M,dblR2_adjusted_M,dblR2_SE_M] = getR2(matBinnedRate-matBinnedStim,matPredMeanCV-matBinnedStim,intK_G);
