...
for intPopIdx=1:intPops
	...
	indKeepTrials = indKeepTrialsVis & vecTrialCorrect;
	indKeepTrialsTest = indKeepTrialsAud & vecTrialCorrect;
...
if boolSavePlots
	strFigFile = ['DimCom4ST2_Correct_Window' sprintf('%.1f',dblBinSizeSecs) 'ProgressionNeuralDynamicsSummary' getDate];
