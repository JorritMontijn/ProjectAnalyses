...
elseif intLoadSim == 100 && boolLoad
	strSimulation = 'xAreaDistributed_IndRetNoise0_0_2019-08-28';
elseif intLoadSim == 102 && boolLoad
	strSimulation = 'xAreaDistributed_IndRetNoise0_2_2019-02-21';
elseif intLoadSim == 104 && boolLoad
	strSimulation = 'xAreaDistributed_IndRetNoise0_4_2019-02-21';
elseif intLoadSim == 106 && boolLoad
	strSimulation = 'xAreaDistributed_IndRetNoise0_6_2019-02-21';
elseif intLoadSim == 108 && boolLoad
	strSimulation = 'xAreaDistributed_IndRetNoise0_8_2019-02-21';
elseif intLoadSim == 110 && boolLoad
	strSimulation = 'xAreaDistributed_IndRetNoise1_0_2019-08-28';
	
	elseif intLoadSim == 112 && boolLoad
	strSimulation = 'xAreaDistributed_IndRetNoise1_2_2019-05-14';
	elseif intLoadSim == 114 && boolLoad
	strSimulation = 'xAreaDistributed_IndRetNoise1_4_2019-05-28';
	elseif intLoadSim == 116 && boolLoad
	strSimulation = 'xAreaDistributed_IndRetNoise1_6_2019-05-28';
	elseif intLoadSim == 118 && boolLoad
	strSimulation = 'xAreaDistributed_IndRetNoise1_8_2019-05-28';
	elseif intLoadSim == 120 && boolLoad
	strSimulation = 'xAreaDistributed_IndRetNoise2_0_2019-05-28';
	
	elseif intLoadSim == 122 && boolLoad
	strSimulation = 'xAreaDistributed_IndRetNoise2_2_2019-08-26';
	elseif intLoadSim == 124 && boolLoad
	strSimulation = 'xAreaDistributed_IndRetNoise2_4_2019-08-26';
	elseif intLoadSim == 126 && boolLoad
	strSimulation = 'xAreaDistributed_IndRetNoise2_6_2019-08-26';
	elseif intLoadSim == 128 && boolLoad
	strSimulation = 'xAreaDistributed_IndRetNoise2_8_2019-08-26';
	elseif intLoadSim == 130 && boolLoad
	strSimulation = 'xAreaDistributed_IndRetNoise3_0_2019-08-26';
