...
for intRunType=vecRunTypes
	...
	for intFile=1:numel(cellRunRecs)
		...
		for intNeuron=1:intNeurons%[1:intNeurons]%43%1:27, 2:69
			...
			[dblZetaP,sZETA] = getTraceZeta(vecPseudoTime,vecPseudoData,matEventTimes,dblUseMaxDur,intResampNum,intPlot,boolDirectQuantile,dblJitterSize,boolUseSuperResolution);
			%pause
			% assign data
		...
		if boolSave
			save([strDataTargetPath 'TraceZeta3Sims_' strRunType 'Resamp' num2str(intResampNum) '.mat' ],...
